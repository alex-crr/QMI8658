 ...
 *
 * This is an alternative to the on-chip Attitude Engine. Software fusion
 * gives you more control over the algorithm parameters and works on all
 * QMI8658 variants, even those without the Attitude Engine feature.
 *
...
void setup() {
    ...
    // Set up interrupt for precise timing
